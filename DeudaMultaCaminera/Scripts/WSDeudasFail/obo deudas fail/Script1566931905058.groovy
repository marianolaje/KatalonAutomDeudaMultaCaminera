...
WebUI.callTestCase(findTestCase('WSDeudasFail/validar response deudas fail'), [('t_response') : response, ('t_cuit') : GlobalVariable.g_cuit], FailureHandling.STOP_ON_FAILURE)
